...
public class CalendarTest {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 */
		  ...
		  *   and DAY_OF_MONTH.Previous values of other calendar fields are retained. 
		  *   If this is not desired,call clear() first.
				Parameters:year the value used to set the YEAR calendar field.month the value used to 
				set the MONTH calendar field.Month value is 0-based. e.g., 0 for January.date the value used 
				to set the DAY_OF_MONTH calendar field.
